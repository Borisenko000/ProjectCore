...
public class Main {
    public static void main(String[] args) {
        // Random variables
        String randomFrom = "Pupa"; // Некоторая случайная строка. Можете выбрать ее самостоятельно.
        String randomTo = "Luba";  // Некоторая случайная строка. Можете выбрать ее самостоятельно.
    ...
    public static class MailService<T> implements Consumer<Sendable<T>> {
        ...
        public void accept(Sendable<T> mail) {
            mailbox.computeIfAbsent(mail.getTo(), k -> new ArrayList<>())
                    .add(mail.getContent());
        }
